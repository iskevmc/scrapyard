...
![Overview](https://github.com/aws/aws-toolkit-vscode/raw/master/./resources/marketplace/overview.png)
...
* Manage certain supported AWS resources in an AWS account (see [Usage](#usage)).
  ...
  * Listing and invoking AWS Lambda functions
  ...
  ![AWS Explorer](https://github.com/aws/aws-toolkit-vscode/raw/master/./resources/marketplace/aws-explorer.png)
...
1. If the **AWS Explorer** isn't showing, open it by choosing the **AWS** icon in the Activity Bar:
   ![AWS Explorer Icon](https://github.com/aws/aws-toolkit-vscode/raw/master/./resources/marketplace/aws-explorer-icon.png)
...
1. Begin typing "**AWS: Create new SAM Application**" and choose that command when you see it.
   ...
   ![Create SAM App 1](https://github.com/aws/aws-toolkit-vscode/raw/master/./resources/marketplace/create-sam-app-still.png)
...
1. Follow the on-screen instructions to finish creating the SAM application, including:
   ...
   ![Create SAM App 2](https://github.com/aws/aws-toolkit-vscode/raw/master/./resources/marketplace/create-sam-app-still-2.png)
...
In summary:
1. Select the **AWS** icon in the Activity Bar, ![AWS Explorer Icon](https://github.com/aws/aws-toolkit-vscode/raw/master/./resources/marketplace/aws-explorer-icon.png), to ensure that the AWS Toolkit for Visual Studio Code is running.
1. Select the Project icon in the Activity Bar, ![Project Explorer Icon](https://github.com/aws/aws-toolkit-vscode/raw/master/./resources/marketplace/project-explorer-icon.png), go to the `hello-world` directory, and open `app.js`.
...
1. Begin typing "**AWS: Deploy SAM Application**" and choose that command when you see it.
   ...
   ![Deploy SAM Application 1](https://github.com/aws/aws-toolkit-vscode/raw/master/./resources/marketplace/sam-deploy-still-1.png)
...
1. Note the status and results in the **OUTPUT** panel. The serverless application is deployed to an AWS CloudFormation stack. If the stack already exists, it is updated; otherwise, a new stack is created. Within a few minutes, the Toolkit displays a deployment success or failure message.
   ...
   ![Deploy SAM Application 1](https://github.com/aws/aws-toolkit-vscode/raw/master/./resources/marketplace/sam-deploy-still-2.png)
...
1. In the **AWS Explorer**, expand the AWS Region that contains the stack, then expand **CloudFormation**. Expand the stack that you want to manage and open the context menu of its resources.
   ...
   ![Deploy SAM Application 1](https://github.com/aws/aws-toolkit-vscode/raw/master/./resources/marketplace/cloudformation-stack-example.png)
