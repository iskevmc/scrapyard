...
var ActiveFeatureKeys;
(function (ActiveFeatureKeys) {
})(ActiveFeatureKeys = exports.ActiveFeatureKeys || (exports.ActiveFeatureKeys = {}));
/**
 ...
 */
class FeatureToggle {
    constructor(configuration, overrideKeys) {
        this.maxFeatures = 5;
        ...
        if (keys.length > this.maxFeatures) {
            throw new Error(`Amount of active feature flags (${keys.length}) exceeds maximum allowed (${this.maxFeatures}).`);
        }
