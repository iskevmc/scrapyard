...
class ExperimentalLanguageClient {
    /**
        ...
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                yield vscode.window.withProgress({
                    ...
                    try {
                        const serverLocation = configuration_1.getConfiguration().languageServer.pathToBinary || Path.join(this.ctx.extensionPath, "lspbin");
                        ...
                        if (!fs.existsSync(executablePath)) {
                            let continueInstall = yield vscode.window.showInformationMessage("Would you like to install Terraform Language Server from juliosueiras/terraform-lsp? \n This provides experimental Terraform 0.12 support", { modal: true }, "Install", "Abort");
                            ...
                            yield vscode.commands.executeCommand('terraform.' + installLanguageServer_1.InstallLanguageServerCommand.CommandName);
                        }
                        ...
                        try {
                            yield this.installCommonProviders(serverLocation);
                        }
                        catch (e) {
                        ...
                        let langClient = new vscode_languageclient_1.LanguageClient('terraformLanguageServer', 'Language Server', serverOptions, clientOptions, true);
    ...
    checkForUpdatedLsp() {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.shouldCheckForLastestRelease()) {
                ...
                const release = yield octokit.repos.getLatestRelease({
                    owner: 'juliosueiras',
                    repo: 'terraform-lsp'
                });
    ...
    installCommonProviders(serverLocation) {
        return __awaiter(this, void 0, void 0, function* () {
...
provider "archive" {}
            ...
            if (!fs.existsSync(defaultProvidersPluginsPath)) {
                ...
                let terminalPid = yield terminal.processId;
            ...
            const providerBinaries = glob.sync(Path.join(serverLocation, ".terraform", "plugins", "**", "terraform-provider*"));
            if (!providerBinaries) {
     ...
     */
    shouldCheckForLastestRelease() {
        const lastUpdateKey = "tfLspLastUpdateCheck";
        let dateLastCheckedValue = this.ctx.globalState.get(lastUpdateKey);
...
ExperimentalLanguageClient.isRunning = false;
exports.ExperimentalLanguageClient = ExperimentalLanguageClient;
