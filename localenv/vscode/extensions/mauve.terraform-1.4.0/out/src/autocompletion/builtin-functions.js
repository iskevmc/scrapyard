...
function GetKnownFunctions(name) {
    if (!name || name === "")
        return exports.KnownFunctions;
    return exports.KnownFunctions.filter((f) => f.name.indexOf(name) !== -1);
}
exports.GetKnownFunctions = GetKnownFunctions;
