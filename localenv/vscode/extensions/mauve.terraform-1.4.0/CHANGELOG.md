...
- Track references to `modules` (Fixes [#165](https://github.com/mauve/vscode-terraform/issues/165))

# 1.3.11

## Fixes

- Track references in ternary expressions (Fixes [#123](https://github.com/mauve/vscode-terraform/issues/123))
- Track references in heredocs (Fixes [#159](https://github.com/mauve/vscode-terraform/issues/159))
- Track references to modules (Fixes [#165](https://github.com/mauve/vscode-terraform/issues/165))
...
- Exclude configured directories from indexing during initial crawl (Fixes [#153](https://github.com/mauve/vscode-terraform/issues/153), [#156](https://github.com/mauve/vscode-terraform/issues/156)) [Thanks to @christek91](https://github.com/christek91)

# 1.3.7

## Fixes

- Upgrade ApplicationInsights SDK (Fixes [#133](https://github.com/mauve/vscode-terraform/issues/133))

# 1.3.6

## Fixes

- Do not show a warning if a `terraform {}` statement is missing a `required_version` attribute (Closes [#132](https://github.com/mauve/vscode-terraform/issues/132))
...
- Fix broken multi-line strings (Closes [#109](https://github.com/mauve/vscode-terraform/issues/109)) [Thanks to @squidfunk](https://github.com/squidfunk)
- (Partially fix [#118](https://github.com/mauve/vscode-terraform/issues/118)) High-CPU usage on auto-complete [Thanks to @michaelmoussa](https://github.com/michaelmoussa)
...
- No longer raise *Output* window on warning or error as it is to intrusive (Closes [#115](https://github.com/mauve/vscode-terraform/issues/115))
...
- Collect references in math expressions (Closes [#95](https://github.com/mauve/vscode-terraform/issues/95))
- Do not eat property accesses during rename refactoring (Closes [#104](https://github.com/mauve/vscode-terraform/issues/104))
...
- Remove duplicates when suggesting completions (Closes [#98](https://github.com/mauve/vscode-terraform/issues/98))
- Show more information when browsing symbols (Closes [#92](https://github.com/mauve/vscode-terraform/issues/92))
...
- Indexing is now done per workspace folder rather than globally (closes [#83](https://github.com/mauve/vscode-terraform/issues/83))
...
- Correctly set current working directory when calling `tflint` (Closes [#82](https://github.com/mauve/vscode-terraform/issues/82))
...
- `.tfvars` Files are now correctly indexed so that *Go To definition*, *Rename* more now work as expected (Closes [#80](https://github.com/mauve/vscode-terraform/issues/80))
...
- Correctly parse references to list and map variables as well as references in nested expressions (Closes [#75](https://github.com/mauve/vscode-terraform/issues/75))

# 1.0.4

## Fixes

- Correctly add `minimatch` to dependencies (Closes [#74](https://github.com/mauve/vscode-terraform/issues/74))

# 1.0.3

## New Features

- Support region for code-folding (`#region`, `#endregion`) (closes [#63](https://github.com/mauve/vscode-terraform/issues/63))
- Add document links to the official terraform documentation (closes [#68](https://github.com/mauve/vscode-terraform/issues/68))

# 1.0.2

## New Features

- CodeLens contribution can be disabled via configuration (closes [#73](https://github.com/mauve/vscode-terraform/issues/73))
- Make it possible to exclude paths from indexing (by default excludes `.terraform`, closes [#72](https://github.com/mauve/vscode-terraform/issues/72))
...
- Format on save is back (closes [#45](https://github.com/mauve/vscode-terraform/issues/45), [#47](https://github.com/mauve/vscode-terraform/issues/47))
...
- The formatter now uses the correct Formatting API so that the builtin command for formatting works as expected (closes [#42](https://github.com/mauve/vscode-terraform/issues/42))
- The formatter no longer has a hardcoded list of approved extensions, instead if the document type is 'terraform' then the formatter can be used to that file (closes [#41](https://github.com/mauve/vscode-terraform/issues/41))
...
- Mark `.tfstate` files as JSON (closes [#38](https://github.com/mauve/vscode-terraform/issues/38))
...
- We no longer create several output channels (closes [#25](https://github.com/mauve/vscode-terraform/issues/25))
...
- Add linting support using [tflint](https://github.com/wata727/tflint) (Closes [#12](https://github.com/mauve/vscode-terraform/issues/12))

# 0.0.11

## What's New

- Only run `terraform fmt` on terraform files so that the plugin can be used for `HCL` files in general (Closes [#18](https://github.com/mauve/vscode-terraform/issues/18))
...
- Also handle `.hcl` files (Closes [#17](https://github.com/mauve/vscode-terraform/issues/17))
...
- [Added block comments in the language specification](https://github.com/mauve/vscode-terraform/pull/7)
  - Fixes [`/* */ don't show as commented` [#4](https://github.com/mauve/vscode-terraform/issues/4)](https://github.com/mauve/vscode-terraform/issues/4)
