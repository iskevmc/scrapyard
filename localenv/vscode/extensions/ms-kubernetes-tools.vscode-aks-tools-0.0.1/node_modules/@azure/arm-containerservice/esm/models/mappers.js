...
export var OpenShiftRouterProfile = {
...
export var OpenShiftManagedClusterMasterPoolProfile = {
...
export var OpenShiftManagedClusterAgentPoolProfile = {
...
export var OpenShiftManagedClusterBaseIdentityProvider = {
...
export var OpenShiftManagedClusterIdentityProvider = {
...
export var OpenShiftManagedClusterAuthProfile = {
...
export var OpenShiftManagedCluster = {
...
export var OpenShiftManagedClusterAADIdentityProvider = {
    ...
    type: {
        ...
        modelProperties: tslib_1.__assign({}, OpenShiftManagedClusterBaseIdentityProvider.type.modelProperties, { clientId: {
...
export var ManagedClusterAgentPoolProfile = {
    ...
    type: {
        ...
        modelProperties: tslib_1.__assign({}, ManagedClusterAgentPoolProfileProperties.type.modelProperties, { name: {
                required: true,
                serializedName: "name",
                constraints: {
...
export var AgentPool = {
    ...
    type: {
        name: "Composite",
        className: "AgentPool",
        modelProperties: tslib_1.__assign({}, SubResource.type.modelProperties, { count: {
                required: true,
...
export var OrchestratorProfile = {
...
export var ManagedClusterAccessProfile = {
    ...
    type: {
        ...
        modelProperties: tslib_1.__assign({}, Resource.type.modelProperties, { kubeConfig: {
...
export var OrchestratorVersionProfile = {
...
export var OrchestratorVersionProfileListResult = {
...
export var OpenShiftManagedClusterListResult = {
